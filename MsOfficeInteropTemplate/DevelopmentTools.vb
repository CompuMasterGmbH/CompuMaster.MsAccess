...
'    Public Sub ExportAllComponents(Optional RedirectToolsOutputToDebug As Boolean = False)
...
'    Public Function ExportVBComponent(VBComp As VBIDE.VBComponent,
...
'    Private Function GetFolderName(VBComp As VBIDE.VBComponent) As String
...
'    Private Function GetFileNameForComponent(VBComp As VBIDE.VBComponent) As String
'        Dim Name As String
'        Name = VBComp.Name
